        ...
        # CAS C : IMPORTER UNE LISTE (📥)
            ...
            with tab_fichier:
                ...
                if type_import_code == "verbe":
                    ...
                    st.info("💡 **Format attendu :** `article mot, traduction en français` (un mot par ligne).  \n**IMPORTANT :**  \n- L'article est facultatif  \n- Si une expression contient des espaces qui ne servent pas à séparer l'article du mot, il faut mettre un point d'exclamation (!) au début de la ligne.", unsafe_allow_html=True)
